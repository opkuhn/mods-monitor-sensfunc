...
ax0.plot(m23_m1bb[:,0],m23_m1bb[:,1],color="blue",linestyle="solid",lw=3,label="MODS1B direct 05/23")
ax0.plot(m23_m1rr[:,0],m23_m1rr[:,1],color="red",linestyle="solid",lw=3,label="MODS1R direct 05/23")
ax0.plot(m23_m1bd[:,0],m23_m1bd[:,1],color="blue",linestyle=":",lw=3,label="MODS1B dual 05/23")
ax0.plot(m23_m1rd[:,0],m23_m1rd[:,1],color="red",linestyle=":",lw=3,label="MODS1R dual 05/23")
ax0.plot(m23_m2bb[:,0],m23_m2bb[:,1],color="lightblue",linestyle="solid",lw=3,label="MODS2B direct 05/23")
ax0.plot(m23_m2rr[:,0],m23_m2rr[:,1],color="lightcoral",linestyle="solid",lw=3,label="MODS2R direct 05/23")
ax0.plot(m23_m2bd[:,0],m23_m2bd[:,1],color="lightblue",linestyle="-.",lw=3,label="MODS2B dual 05/23")
ax0.plot(m23_m2rd[:,0],m23_m2rd[:,1],color="lightcoral",linestyle="-.",lw=3,label="MODS2R dual 05/23")
