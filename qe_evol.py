...
m1_bdual = np.genfromtxt("2011/sensx_m1_bdual_qe_tel0.out")
m1_blue = np.genfromtxt("2011/sens_m1_blueonly_qe_tel0.out")
m1_rdual = np.genfromtxt("2011/sens_m1_rdual_qe_tel0.out")
m1_red = np.genfromtxt("2011/sens_m1_redonly_qe_tel0.out")
m2_bdual = np.genfromtxt("2015MODS2/sensx_m2_bdual_qe_tel0.out")
m2_blue = np.genfromtxt("2015MODS2/sensx_m2_blueonly_qe_tel0.out")
m2_rdual = np.genfromtxt("2015MODS2/sensx_m2_rdual_qe_tel0.out")
m2_red = np.genfromtxt("2015MODS2/sensx_m2_redonly_qe_tel0.out")

#Now - Sep2022. M2red has increased from what it was at comm. 
# M1 has fallen dramatically.
m1_bdual_sep22 = np.genfromtxt("2022/2022Sep/log_dual_m1b_sep22_qe_tel0.out")
m1_rdual_sep22 = np.genfromtxt("2022/2022Sep/log_dual_m1r_sep22_qe_tel0.out")
m2_rdual_sep22 = np.genfromtxt("2022/2022Sep/log_dual_m2r_sep22_qe_tel0.out")
m2_bdual_sep22 = np.genfromtxt("2022/2022Sep/log_dual_m2b_sep22_qe_tel0.out")
m2_blue_sep22 = np.genfromtxt("2022/2022Sep/log_blue_m2b_sep22_qe_tel0.out")
m1_blue_sep22 = np.genfromtxt("2022/2022Sep/log_blue_m1b_sep22_qe_tel0.out")
m1_red_sep22 = np.genfromtxt("2022/2022Sep/log_red_m1r_sep22_qe_tel0.out")
m2_red_sep22 = np.genfromtxt("2022/2022Sep/log_red_m2r_sep22_qe_tel0.out")
...
#m1_bdual_dec22 = np.genfromtxt("2022/2022Dec/log_dual_m1b_dec22_qe_tel0.out")
#m1_rdual_dec22 = np.genfromtxt("2022/2022Dec/log_dual_m1r_dec22_qe_tel0.out")
#m2_rdual_dec22 = np.genfromtxt("2022/2022Dec/log_dual_m2r_dec22_qe_tel0.out")
#m2_bdual_dec22 = np.genfromtxt("2022/2022Dec/log_dual_m2b_dec22_qe_tel0.out")
#m2_blue_dec22 = np.genfromtxt("2022/2022Dec/log_blue_m2b_dec22_qe_tel0.out")
#m1_blue_dec22 = np.genfromtxt("2022/2022Dec/log_blue_m1b_dec22_qe_tel0.out")
#m1_red_dec22 = np.genfromtxt("2022/2022Dec/log_red_m1r_dec22_qe_tel0.out")
#m2_red_dec22 = np.genfromtxt("2022/2022Dec/log_red_m2r_dec22_qe_tel0.out")
...
ax.set_ylabel("Efficiency MODS +telescope (reflectivity=100%), airmass=0", fontsize=14)
